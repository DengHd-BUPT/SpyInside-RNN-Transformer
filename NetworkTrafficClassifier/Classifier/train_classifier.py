...
from dataset import ClassificationQuantizedDataset
...
def main():
    ...
    parser.add_argument(
        '--test_dataset',
        default='/traffic-classifier/datasets/test_4c93174d7808b1487aa3288084365d76_no_mawi_unswnb_iscxvpn.csv',
        help='path to preprocessed .csv dataset',
    )
    parser.add_argument(
        '--pretrained_path',
    ...
    logger = NeptuneLogger(
        ...
        params=vars(args),
        upload_source_files=[(BASE_DIR / 'model.py').as_posix()]
    )

    checkpoint_dir = f'{nn_classifier.__class__.__name__}_checkpoints7' #
