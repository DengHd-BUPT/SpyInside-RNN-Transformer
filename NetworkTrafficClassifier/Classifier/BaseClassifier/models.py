...
from Transformer4NetworkTraffic.evaluation_utils.classification import Reporter
from Transformer4NetworkTraffic.settings import RANDOM_SEED
...
class BaseClassifier(LightningModule):
    ...
    def test_epoch_end(self, outputs):
        print("-----Output targets & predictions-----")
        for x in outputs:
            targets = x['targets']
